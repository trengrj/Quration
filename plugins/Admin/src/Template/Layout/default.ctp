    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <li>
                    <?= $this->Html->link('<i class="fa fa-fw fa-child"></i> ' . __('Categories'), ['controller' => 'Categories', 'action' => 'index', 'plugin' => 'Categories'], ['escape' => false]) ?>
                </li>
                <li>
                    <?= $this->Html->link('<i class="fa fa-fw fa-map-marker"></i> ' . __('Places'), ['controller' => 'Places', 'action' => 'index', 'plugin' => 'Places'], ['escape' => false]) ?>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
